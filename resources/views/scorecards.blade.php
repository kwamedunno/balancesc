                            ...
                            <tbody> 
                                @for($i=0; $i<sizeof($scorecards); $i++) 
                                    <tr>
                                        ...
                                        <td><a href="{{ route('show.view.scorecard', $scorecards[$i]['id']) }}" ><button class="btn btn-info" style="padding: 0.3rem 0.5rem;"><i class="la la-eye"></i></button></a>
                                            @if((Auth::user()->role)==1)
                                                <a href="{{ route('delete.scorecard', $scorecards[$i]['id']) }}"><button class="btn btn-info" style="padding: 0.3rem 0.5rem;"><i class="la la-trash"></i></button></a>
                                            @endif
                                        </td>
