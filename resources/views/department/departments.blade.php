                            ...
                            <tbody> 
                                @for($i=0; $i<sizeof($department); $i++) 
                                    <tr>
                                        ...
                                        <td><a href="{{ route('show.department.staff',$department[$i]['id'])}}"><button data-target="" class="btn btn-warning" style="padding: 0.3rem 0.5rem;"><i class="la la-eye"></i></button></a></td>
                                    </tr>
                                @endfor
                            </tbody>
                            <tfoot>
