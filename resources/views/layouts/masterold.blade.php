...
<body class="horizontal-layout horizontal-menu horizontal-menu-padding material-horizontal-layout material-layout content-left-sidebar email-application " data-open="click" data-menu="vertical-content-menu" data-col="2-columns">
        ...
        <div class="navbar-wrapper">
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item"><a class="navbar-brand" href="index.html"><img class="brand-logo" alt="modern admin logo" src="{{ asset('app-assets/images/logo/zeepay_logo.png') }}">
                            <h3 class="brand-text">Balanced ScoreCards</h3>
                        </a></li>
    ...
    <div class="app-content content">
        <div class="content-wrapper">
            ...
            <div class="main-menu menu-static menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
                ...
                <div class="main-menu-content">
                    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                        <li class=" nav-item"><a href="{{ route('show.scorecards') }}"><i class="la la-book"></i><span class="menu-title" data-i18n="nav.dash.main">Scorecards</span></a>
                        </li>
                    </ul>
                </div>
                <div class="main-menu-content">
                    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                        <li class=" nav-item"><a href="{{ route('show.staff') }}"><i class="la la-group"></i><span class="menu-title" data-i18n="nav.dash.main">Staff</span></a>
                        </li>
                    </ul>
                </div>
                <div class="main-menu-content">
                        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                            <li class=" nav-item"><a href="{{ route('show.departments') }}"><i class="la la-building"></i><span class="menu-title" data-i18n="nav.dash.main">Departments</span></a>
                            </li>
                        </ul>
                    </div>
            </div>
    ...
    <footer class="footer footer-static footer-light navbar-border">
        <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span class="float-md-left d-block d-md-inline-block">Copyright &copy; 2019 <a class="text-bold-800 grey darken-2" href="https://myzeepay.com" target="_blank">ZeePay Ltd</a></span><span class="float-md-right d-none d-lg-block"></span></p>
    </footer>
    <!-- END: Footer-->
